...
aut aut aut maxime quia temporibus ut omnis`}],Dc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}];function Rc(e,t,i){const n=new Map;i.forEach(o=>{n.set(o.id,o)});const a=new Map;return t.forEach(o=>{a.has(o.postId)||a.set(o.postId,[]),a.get(o.postId).push(o)}),e.map(o=>{const r=n.get(o.userId)||{},s=a.get(o.id)||[];return{...o,user:{id:r.id,name:r.name,username:r.username,email:r.email},comments:s.map(m=>({id:m.id,name:m.name,email:m.email,body:m.body}))}})}const jc=()=>{const e=Rc(Mc,Tc,Dc);return j.jsxs("section",{className:"App",children:[j.jsx("h1",{className:"App__title",children:"Static list of posts"}),j.jsx(Lc,{posts:e})]})};em(document.getElementById("root")).render(j.jsx(jc,{}));
